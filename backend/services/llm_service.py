...
class LLMService:
    ...
    async def run_meeting_turn(self, topic: str, company_context: str, agent_name: str, persona_prompt: str, history: List[Dict] = [], attachment_path: str = None, user_message: str = None) -> str:
        ...
        if 'gemini' in agent_name.lower():
            ...
            return await self._get_ollama_chat(agent_name, history, user_trigger, system_prompt, attachment_path)
